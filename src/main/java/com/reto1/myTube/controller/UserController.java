...
import com.reto1.myTube.model.user.UserGetRequest;
...
public class UserController {
	...
	public ResponseEntity<UserGetRequest> getUserByEmail(@PathVariable("email") String email) {
		UserGetRequest userGetRequest = userDTOtoUserGetRequest(userService.findByEmail(email));
		return new ResponseEntity<>(userGetRequest, HttpStatus.OK);
	}
	...
	private UserGetRequest userDTOtoUserGetRequest(UserDTO userDto) {
